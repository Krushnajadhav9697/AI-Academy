...
from decouple import config, Csv  # ✅ Add decouple
...
# ✅ Simple JWT config (email-based login)
SIMPLE_JWT = {
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='no-reply@yourapp.com')
